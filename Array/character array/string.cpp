...
int getlength( char string[]){ // we don't pass the size of array in string 
    int count =0;// this will count the length
    for (int i=0;string[i] !='\0';i++){ // jb tk null character nhi aa rha tbtk iterate krwa rhe h 
       count++;
    }
    return count;
...
int main()
{
    ...
    cin>>string;
   // string[2]='\0';//storing null character at index 2
    cout<<"your name is : ";
